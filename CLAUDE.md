...
This project is indexed by GitNexus as **psoulc** (17365 symbols, 23094 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
